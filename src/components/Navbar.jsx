...
const Navbar = () => {
  ...
  return (
    <nav className="border-b bg-gray-800 border-black shadow-md">
      
      <div className="grid sm:grid-cols-3 grid-cols-2 font-semibold p-2 border-b border-gray-500">
        
        <div className="self-center  text-left mb-2  px-5">
        ...
        <Link className="flex items-center sm:justify-center justify-end sm:px-0 px-5 sm:mb-2 mb-0" to="/">
          <div className="h-10">
        ...
        <div className="flex justify-center sm:col-span-1 col-span-2 md:justify-end items-center space-x-4 px-5">
          {/* Social Links */}
          {["#", "#", "#", "#", "#"].map((link, index) =>
            <Link
              key={index}
            ...
            >
              <svg
                ...
                fill="currentColor"
                viewBox={viewbox[index]}
              >
                
                {index !== 1 ?<path fillRule="evenodd" d={pathd[index]} clipRule="evenodd" />:<path  d={pathd[index]} />}
              </svg>
            </Link>
          )}
        </div>
      ...
      <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400">
        <ul className="flex space-x-4 justify-evenly md:justify-center font-semibold text-sm sm:text-base py-2 px-2 sm:px-4 whitespace-nowrap md:whitespace-normal">
          {[
            "sports",
            "business",
            "entertainment",
            ...
            <NavLink
              ...
              className={
                useActiveLink(category)
                  ? "text-purple-700 border-b-2 border-purple-700"
                  : "text-purple-300"
              }
            >
              <li className="capitalize cursor-pointer px-4 py-2 md:px-6 hover:text-purple-700 transition-colors duration-300">
                {category}
              </li>
            </NavLink>
          )}
