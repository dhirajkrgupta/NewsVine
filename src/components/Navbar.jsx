...
const Navbar = () => {
  ...
  const month =  ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"].at(d.getMonth());
  const date = d.getDate();
  const day = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"].at(d.getDay());
  return (
    <nav className="border-b-2 grid ">
      <div className="grid grid-cols-3  font-semibold  p-2 border-b">
        <div className="self-center">
          <p className="font-semibold">{day}, {month} {date}, { year}</p>
        </div>
      <Link
